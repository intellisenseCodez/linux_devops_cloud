...
- `lscup` - displays detailed CPU architecture information—such as cores, threads, sockets etc
- `free -h` - displaying the total amount of free and used physical and swap memory. 
